          ...
          <div className="relative pr-5 lg:pl-6">
            <div className="mx-auto max-w-[850px] text-center lg:text-left">
              ...
              <p className="mt-8 text-zinc-300 text-[clamp(1rem,1.5vw,1.4rem)] 2xl:pt-10 2xl:pb-10">
                Found-It is your school’s official lost-and-found system.
                Quickly report items, search what’s been found, and help get
                belongings back to their owners.
              </p>

              {/* CTA buttons */}
              <div className="mt-12 flex flex-col items-center gap-4 sm:flex-row sm:items-center sm:justify-center lg:justify-start">
                <button
                  className="rounded-md bg-purple-600 px-6 py-3 text-sm font-medium text-white transition hover:bg-purple-500"
                  onClick={() => {
                    if (itemsRef.current) {
